    ...
    if data.get("vat") and hasattr(Partner, "check_vat"):
        ...
        partner_dummy = Partner.new({
            ...
            'document_type_id': (int(data['document_type_id'])
                                 if data.get('document_type_id') else False),
...
WebsiteSale._checkout_form_save = _checkout_form_save
...
def address(self, **kw):
    ...
    document = 'document_type_id' in values and values['document_type_id'] != '' and request.env['res.document.type'].browse(int(values['document_type_id']))
...
dep_decorator = http.route(['/shop/address'], type='http', methods=['GET', 'POST'], auth="public", website=True)
address.routing_type = 'http'

WebsiteSale.address = dep_decorator(address)
