...
class AccountMove(models.Model):
    ...
    afip_fce_es_anulacion = fields.Boolean(
        ...
        help="Solo utilizado en comprobantes MiPyMEs (FCE) del tipo debito o credito.\n"
        "- SI: si el comprobante asociado se encuentra rechazado por el comprador\n"
        "- NO: si el comprobante asociado NO se encuentra rechazado por el comprador",
    )
