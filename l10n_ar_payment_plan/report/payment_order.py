...
report_sxw.report_sxw('report.payment.order.plan', 'payment.order', 'addons/l10n_ar_payment_plan/report/payment_order.rml', parser=payment_order, header="external")
