...
class TestWSAA(TransactionCase):
    ...
    def setUp(self):
        ...
        self.wsaa_demo = self.browse_ref(
            "l10n_ar_wsaa.wsaa_config_demo")
        self.wsaa_service = self.browse_ref(
            "l10n_ar_wsaa.afipws_service_wsaa_test")
    ...
    def test_authentication(self):
        ...
        with mock.patch('openerp.addons.l10n_ar_wsaa.utils.wsaa_suds.Client',
                        new=common.WSAA_Client) as mock_client:
