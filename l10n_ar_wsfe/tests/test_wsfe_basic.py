...
from odoo.addons.l10n_ar_wsaa.tests.common import WSAA_Client
from odoo.addons.l10n_ar_wsfe.tests.common import WSFE_Client
from odoo.addons.l10n_ar_wsfe.wsfetools.wsfe_suds import WSFEv1
