...
class account_journal(osv.osv):
    ...
    _columns = {
        ...
        'type': fields.selection([('sale', 'Sale'),('sale_refund','Sale Refund'), ('purchase', 'Purchase'), ('purchase_refund','Purchase Refund'), ('cash', 'Cash'), ('bank', 'Bank and Checks'), ('general', 'General'), ('situation', 'Opening/Closing Situation'), ('receipt', 'Receipts'), ('payment', 'Payment')], 'Type', size=32, required=True,
    ...
    def create_sequence(self, cr, uid, vals, context=None):
        ...
        if journal_type not in ['receipt', 'payment']:
            return super(account_journal, self).\
                    create_sequence(cr, uid, vals, context)
